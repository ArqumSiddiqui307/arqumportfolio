<style>
    ...
    $hrmimage[1] = "AttendanceRecord.png";
    $hrmimage[2] = "UploadSheet.png";
    
    $hrmimage[3] = "Payroll.png";
    $hrmimage[4] = "Adjustment.png";
    $hrmimage[5] = "EmployeeTimings.png";
    $hrmimage[6] = "EmployeeSalary.png";
    ?>
<div class="modal fade" id="getmeImagePayroll">
    <div class="modal-dialog">
        <div class="modal-content" style="width: 150%;margin-left: -100px;"> 
            <div id="loader"></div>
            <div class="modal-header">
                <h4 class="modal-title">Arqum Portfolio (Pay Roll)</h4>
            ...
            <div class="modal-body" id="body" style="height: 625px; overflow-y: scroll;">
                ...
                <center><h5 id="user" style="display: none;">Attendance Record</h5></center>
                <center><h5 id="employee" style="display: none;">Upload Sheet</h5></center>
                
                <center><h5 id="candidategrid" style="display: none;">Pay Roll</h5></center>
                <center><h5 id="candidatelist" style="display: none;">Adjustment</h5></center>
