...
<p>To be an active employee in your company and I can develop and utilize my versatile skills,
    I can use knowledge of Software Engineering to uplift the dignity of organization through hard work,
    loyalty and honesty and do best for the benefit of organization with the cooperation of seniors.</p>
</div>
@yield('content')
