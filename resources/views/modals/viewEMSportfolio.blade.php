        ...
        <div class="modal-content" style="width: 150%;margin-left: -100px;"> 
            ...
            <div class="modal-body" id="body" style="height: 625px; overflow-y: scroll;">
                ...
                <span class='zoom' id='ex2'>
                    <img class="img-fluid img-thumbnail" id="1" src="{{ URL::to('public/images/EMS/')}}/{{$hrmimage[0]}}" onclick="cursor()" style="display: block; cursor: zoom-in;"/> 
                    <img class="img-fluid img-thumbnail" id="2" src="{{ URL::to('public/images/EMS/')}}/{{$hrmimage[1]}}" onclick="cursor()" style="display: none; cursor: zoom-in;"/>
                    <img class="img-fluid img-thumbnail" id="3" src="{{ URL::to('public/images/EMS/')}}/{{$hrmimage[2]}}" onclick="cursor()" style="display: none; cursor: zoom-in;"/>
                    
                    <img class="img-fluid img-thumbnail" id="4" src="{{ URL::to('public/images/EMS/')}}/{{$hrmimage[3]}}" onclick="cursor()" style="display: none; cursor: zoom-in;"/>
                    <img class="img-fluid img-thumbnail" id="5" src="{{ URL::to('public/images/EMS/')}}/{{$hrmimage[4]}}" onclick="cursor()" style="display: none; cursor: zoom-in;"/>
                </span>
